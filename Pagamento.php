...
<div id="pix-details" class="payment-method w3-center w3-padding">
    <form action="">
        ...
        <div class="right">
            ...
            ?>
            <hr style="border:1px solid #ccc; margin: 0 15px;">
                <div class="w3-center" style="font-size: 13px"><a href="/carrinho" style="text-decoration: none;">Voltar <i class="fa-solid fa-arrow-left"style="margin-left:5px; font-size: 13px;"></i></a></div>
            </div>
        </div>
    </div>
