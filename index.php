...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado->num_rows > 0) {
        ...
        if ($conexao->query($sql) === TRUE) {
            echo "<script>window.location.href='/cadastro-sucesso';</script>";
            exit;
        } else {
...
<body>
    <form action="/cadastro-sucesso" method="POST" class="formulario w3-card-4 w3-topbar w3-rightbar w3-leftbar w3-bottombar card-login cartao">
        ...
        <div class="w3-center" style="margin-right:90px;margin-bottom:30px;">
            ...
            <a href="/login" class="a" style="margin-left: 5px;color:#5b6b8b;">
